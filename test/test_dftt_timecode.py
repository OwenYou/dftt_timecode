...
@pytest.fixture(params=[('00:00:01:00', 'auto', 24, False, True),
                        ('1000', 'auto', 119.88, True, True),
                        ('1.0', 'auto', Fraction(60000, 1001),
                         True, True),
...
def test_type(timecode_value, timecode_type, fps, drop_frame, strict, result_type):
    assert TC(timecode_value, timecode_type, fps,
              drop_frame, strict).type == result_type
...
def test_auto_type(timecode_value, timecode_type, fps, drop_frame, strict, result_type):
    assert TC(timecode_value, 'auto', fps,
              drop_frame, strict).type == result_type
...
@pytest.mark.parametrize(
    ...
    [
        ...
        ('3600.0s', 'auto', Fraction(60000, 1001),
         True, True, Fraction(60000, 1001)),
    ],
    ids=['smpte', 'frame', 'time']
)
def test_fps(timecode_value, timecode_type, fps, drop_frame, strict, result_fps):
    assert TC(timecode_value, timecode_type, fps,
              drop_frame, strict).fps == result_fps
...
def test_framecount(timecode_value, timecode_type, fps, drop_frame, strict, result_framecount):
    assert TC(timecode_value, timecode_type, fps, drop_frame,
              strict).framecount == result_framecount
...
def test_dropframe_strict(timecode_value, timecode_type, fps, drop_frame, strict):
    assert TC(timecode_value, timecode_type, fps,
              drop_frame, strict).is_drop_frame is drop_frame
    assert TC(timecode_value, timecode_type, fps,
              drop_frame, strict).is_strict is strict
...
@pytest.fixture(
    params=[
        ...
        ('1.0s', 'auto', Fraction(60000/1001),
         True, True, 1, 1),
        ('00:01:00;02', 'auto', 29.97, True,
         True, 60.06006, Fraction(1800/29.97)),
    ],
    ids=['smpte', 'frame',
         'time', 'smpte_nf']
)
...
def test_timestamp(timestamp_data):
    assert TC(*timestamp_data[:-2]
              ).timestamp == pytest.approx(timestamp_data[-2])
...
@pytest.fixture(params=[('01:00:00:101', 'auto', 120, False, True, 24, True, '01:00:00:100'),
                        ('01:00:00:101', 'auto', 120, False, True, 24, False, '01:00:00:101')], ids=["120_24_Round", "120_24_NRound"])
...
@pytest.fixture(params=[('25:00:01:101', 'auto', 120, False, False, True, '01:00:01:101'),
...
@pytest.mark.parametrize(argnames="timecode_value, timecode_type, fps, drop_frame, strict,output_type,output_str,part_1,part_2,part_3,part_4",
                         argvalues=[('11:22:33:13', 'auto', 24, False, True, 'smpte', '11:22:33:13', '11', '22', '33', '13'),
                                    ('11:22:33,456', 'auto', 24, False, True, 'srt',
                                     '11:22:33,456', '11', '22', '33', '456'),
                                    ],
                         ids=['smpte', 'srt'])
def test_timecode_output_part(timecode_value, timecode_type, fps, drop_frame, strict, output_type, output_str, part_1, part_2, part_3, part_4):
    tc = TC(timecode_value, timecode_type, fps, drop_frame, strict)
...
def neg_result(request):
    neg_result_data = {'00:00:01:00': '23:59:59:00',
                       '1000': '10356632',
                       '1.0': '86399.0',
...
@pytest.fixture(params=[(('00:00:01:00', 'auto', 24, False, True), ('23:59:59:00', 'auto', 24, False, False), ('00:00:00:00', 'auto', 24, False, True)),
                        (('1000', 'auto', 119.88, True, True), ('120', 'auto',119.88, True, True), ('1120', 'auto', 119.88, True, True)),
                        pytest.param((('1000', 'auto', 119.88, True, True), ('1s', 'auto',119.88, True, True), ('1120', 'auto', 119.88, True, True)),marks=pytest.mark.xfail),
                        (('1s', 'auto', Fraction(60000, 1001),True, True), ('1.0', 'auto', Fraction(60000, 1001),True, True), ('2s', 'auto', Fraction(60000, 1001),True, True)),
                        (('00:00:59;29', 'auto', 29.97, True, True),('00:00:00;01', 'auto', 29.97, True, True),('00:01:00;02', 'auto', 29.97, True, True)),
                        (('01:00:00,123', 'auto', 24, False, True),('01:00:00,878', 'auto', 24, False, True),('02:00:01,001', 'auto', 24, False, True))],
...
@pytest.fixture(params=[(('00:00:00:23', 'auto', 24, False, True), 1, ('00:00:01:00', 'auto', 24, False, True)),
                        (('1000', 'auto', 119.88, True, True), 111, ('1111', 'auto', 119.88, True, True)),
                        pytest.param((('1s', 'auto', Fraction(60000, 1001),True, True), 60, ('2s', 'auto', Fraction(60000, 1001),True, True)),marks=pytest.mark.xfail),
                        (('00:00:59;29', 'auto', 29.97, True, True),1,('00:01:00;02', 'auto', 29.97, True, True)),
                        (('01:00:00,123', 'auto', 24, False, True),24,('01:00:01,123', 'auto', 24, False, True)),
                        (('00:00:00:23', 'auto', 24, False, True), 1.0, ('00:00:01:23', 'auto', 24, False, True)),
                        pytest.param((('1000', 'auto', 119.88, True, True), 1.0, ('1120', 'auto', 119.88, True, True)),marks=pytest.mark.xfail),
                        (('1s', 'auto', Fraction(60000, 1001),True, True), 60.0, ('61s', 'auto', Fraction(60000, 1001),True, True)),
                        pytest.param((('00:00:59;29', 'auto', 29.97, True, True),1.0,('00:01:01;01', 'auto', 29.97, True, True)),marks=pytest.mark.xfail),
                        (('01:00:00,123', 'auto', 24, False, True),0.877,('01:00:01,000', 'auto', 24, False, True)),
                        pytest.param((('00:09:59;00', 'auto', 29.97, True, True),Fraction(1000,1001),('00:10:00;00', 'auto', 29.97, True, True)),marks=pytest.mark.xfail)
                        ],
                ids=['smpte_int', 'frame_int', 'time_int_xfail', 'smpte_df_int', 'srt_int',
                     'smpte_float','frame_float_xfail','time_float','smpte_df_float','srt_float',
...
@pytest.fixture(params=[(('00:00:01:00', 'auto', 24, False, True), ('00:00:02:00', 'auto', 24, False, False), ('23:59:59:00', 'auto', 24, False, True)),
                        (('1000', 'auto', 119.88, True, False), ('1001', 'auto',119.88, True, False), ('-1', 'auto', 119.88, True, False)),
                        (('2s', 'auto', Fraction(60000, 1001),True, True), ('1.0', 'auto', Fraction(60000, 1001),True, True), ('1s', 'auto', Fraction(60000, 1001),True, True)),
                        (('00:00:59;29', 'auto', 29.97, True, True),('1', 'auto', 29.97, True, True),('00:00:59;28', 'auto', 29.97, True, True)),
                        (('00:00:00,100', 'auto', 24, False, True),('00:00:01,000', 'auto', 24, False, True),('23:59:59,100', 'auto', 24, False, True))],
                ids=['smpte', 'frame', 'time', 'smpte_df', 'srt'])
...
@pytest.fixture(params=[(('00:00:00:23', 'auto', 24, False, True), 23, ('00:00:00:00', 'auto', 24, False, True)),
                        (('1000', 'auto', 119.88, True, False), 1001, ('-1', 'auto', 119.88, True, False)),
                        pytest.param((('1s', 'auto', Fraction(60000, 1001),True, True), 60, ('0s', 'auto', Fraction(60000, 1001),True, True)),marks=pytest.mark.xfail),
                        (('00:00:59;29', 'auto', 29.97, True, True),1,('00:00:59;28', 'auto', 29.97, True, True)),
                        (('01:00:00,123', 'auto', 24, False, True),24,('00:59:59,123', 'auto', 24, False, True)),
                        (('00:00:00:23', 'auto', 24, False, True), 1.0, ('23:59:59:23', 'auto', 24, False, True)),
                        (('1000', 'auto', 120, True, True), 1.0, ('880', 'auto', 120, True, True)),
                        (('1s', 'auto', 60,True, True), 60.0, ('86341s', 'auto', 60,True, True)),
                        pytest.param((('00:01:01;02', 'auto', 29.97, True, True),1.0,('00:01:00;00', 'auto', 29.97, True, True)),marks=pytest.mark.xfail),
                        (('01:00:00,123', 'auto', 24, False, True),-0.123,('01:00:00,246', 'auto', 24, False, True)),
                        ],
                ids=['smpte_int', 'frame_int', 'time_int_xfail', 'smpte_df_int', 'srt_int',
                     'smpte_float','frame_float_xfail','time_float','smpte_df_float','srt_float'])
...
@pytest.fixture(params=[(23, ('00:00:00:23', 'auto', 24, False, True),('00:00:00:00', 'auto', 24, False, True)),
                        (1001,('1002', 'auto', 119.88, True, False),  ('-1', 'auto', 119.88, True, False)),
                        pytest.param((60, ('1s', 'auto', Fraction(60000, 1001),True, True), ('0s', 'auto', Fraction(60000, 1001),True, True)),marks=pytest.mark.xfail),
                        (1800,('00:00:59;29', 'auto', 29.97, True, True),('00:00:00;01', 'auto', 29.97, True, True)),
                        (24,('00:00:00,123', 'auto', 24, False, True),('00:00:00,877', 'auto', 24, False, True)),
                        (1.0,('00:00:00:23', 'auto', 24, False, True), ('00:00:00:01', 'auto', 24, False, True)),
                        (10.0,('1000', 'auto', 120, True, True),  ('200', 'auto', 120, True, True)),
                        (1.0, ('60s', 'auto', 60,True, True), ('86341s', 'auto', 60,True, True)),
                        (0.123,('01:00:00,123', 'auto', 24, False, True),('23:00:00,000', 'auto', 24, False, True)),
                        ],
                ids=['smpte_int', 'frame_int', 'time_int_xfail', 'smpte_df_int', 'srt_int',
                     'smpte_float','frame_float_xfail','time_float','srt_float'])
...
@pytest.fixture(params=[(('00:00:00:23', 'auto', 24, False, True),2,('00:00:01:22', 'auto', 24, False, True)),
                        (('1002', 'auto', 119.88, True, False),2,  ('2004', 'auto', 119.88, True, False)),
                        (('1s', 'auto', Fraction(60000, 1001),True, True),60, ('60s', 'auto', Fraction(60000, 1001),True, True)),
                        (('00:01:00;02', 'auto', 29.97, True, True),10,('00:10:00;18', 'auto', 29.97, True, True)),
                        (('00:00:00,123', 'auto', 24, False, True),10,('00:00:01,230', 'auto', 24, False, True)),
                        (('00:00:00:00', 'auto', 24, False, True), 10000.11,('00:00:00:00', 'auto', 24, False, True)),
                        (('1000', 'auto', 120, True, True), 1.5, ('1500', 'auto', 120, True, True)),
                        (('60s', 'auto', 60,True, True),1.5, ('90s', 'auto', 60,True, True)),
                        (('01:00:00,000', 'auto', 24, False, True),1.5,('01:30:00,000', 'auto', 24, False, True)),
                        ],
                ids=['smpte_int', 'frame_int', 'time_int', 'smpte_df_int', 'srt_int',
                     'smpte_float','frame_float','time_float','srt_float'])
...
@pytest.fixture(params=[(('00:00:01:00', 'auto', 24, False, True),2,('00:00:00:12', 'auto', 24, False, True)),
                        (('114514', 'auto', 119.88, True, False),2,  ('57257', 'auto', 119.88, True, False)),
                        (('60s', 'auto', Fraction(60000, 1001),True, True),60, ('1s', 'auto', Fraction(60000, 1001),True, True)),
                        (('00:01:00;02', 'auto', 29.97, True, True),0.1,('00:10:00;18', 'auto', 29.97, True, True)),
                        (('00:00:01,234', 'auto', 24, False, True),Fraction(1,2),('00:00:02,468', 'auto', 24, False, True)),
                        (('00:00:00:00', 'auto', 24, False, True), 10000.11,('00:00:00:00', 'auto', 24, False, True)),
                        (('1000', 'auto', 120, True, True), 2.5, ('400', 'auto', 120, True, True)),
                        (('60s', 'auto', 60,True, True),1.5, ('40s', 'auto', 60,True, True)),
                        (('01:00:00,000', 'auto', 24, False, True),0.5,('02:00:00,000', 'auto', 24, False, True)),
                        ],
                ids=['smpte_int', 'frame_int', 'time_int', 'smpte_df_int', 'srt_int',
                     'smpte_float','frame_float','time_float','srt_float'])
...
def test_div(div_num_data):
    ...
    from dftt_timecode.error import DFTTTimecodeOperatorError
    with pytest.raises(DFTTTimecodeOperatorError):
        div_num_data[1]/div_num_data[0]


     
@pytest.mark.parametrize(
    argnames="tc_value,compare_tc_value",
    argvalues=[pytest.param(('00:00:01:00', 'auto', 24, False, True),('00:00:01:00', 'auto', 25, False, True),marks=pytest.mark.xfail(raises=DFTTTimecodeOperatorError)),
               (('00:00:01:00', 'auto', 24, False, True),('24', 'auto', 24, False, True)),
               (('00:10:00:00', 'auto', 29.97, True, True),('600.0', 'auto', 29.97, True, True)),
               (('00:00:01:60', 'auto', 120, False, True),('00:00:01,500', 'auto', 120, False, True)),
               ],
...
@pytest.mark.parametrize(
    ...
    argvalues=[(('00:00:01:00', 'auto', 24, False, True),24),
    ...
    ids=['smpte_int','frame_int','time_int_xfail','srt_int',
         'smpte_float','frame_float','time_float','srt_float']
)
...
@pytest.mark.parametrize(
    ...
    argvalues=[(('00:00:01:00', 'auto', 24, False, True),('00:00:00:22', 'auto', 24, False, True),True),
               (('00:00:01:00', 'auto', 24, False, True),('15', 'auto', 24, False, True),True),
               (('00:00:01:00', 'auto', 24, False, True),('1.0', 'auto', 24, False, True),False),
               (('00:00:01:00', 'auto', 24, False, True),('00:00:00,500', 'auto', 24, False, True),True),
    ...
    ids=['smpte_smpte','smpte_frame','smpte_time','smpte_srt',
         'smpte_int','frame_int','time_int','srt_int',
         'smpte_float','frame_float','time_float','srt_float',
         ]
)
...
@pytest.mark.parametrize(
    ...
    argvalues=[(('00:00:01:00', 'auto', 24, False, True),('00:00:00:22', 'auto', 24, False, True),True),
               (('00:00:01:00', 'auto', 24, False, True),('15', 'auto', 24, False, True),True),
               (('00:00:01:00', 'auto', 24, False, True),('1.0', 'auto', 24, False, True),True),
               (('00:00:01:00', 'auto', 24, False, True),('00:00:00,500', 'auto', 24, False, True),True),
               (('00:00:01:00', 'auto', 24, False, True),22,True),
               (('1919', 'auto', 24, False, True),114514,False),
               (('2s', 'auto', 24, False, True),24,True),
...
@pytest.mark.parametrize(
    argnames="tc_value,compare_value,xvalue",
    argvalues=[(('00:00:01:00', 'auto', 24, False, True),('00:00:00:22', 'auto', 24, False, True),False),
               (('00:00:01:00', 'auto', 24, False, True),('15', 'auto', 24, False, True),False),
               (('00:00:01:00', 'auto', 24, False, True),('1.0', 'auto', 24, False, True),False),
               (('00:00:01:00', 'auto', 24, False, True),('00:00:00,500', 'auto', 24, False, True),False),
...
@pytest.mark.parametrize(
    ...
    argvalues=[(('00:00:01:00', 'auto', 24, False, True),('00:00:00:22', 'auto', 24, False, True),False),
               (('00:00:01:00', 'auto', 24, False, True),('15', 'auto', 24, False, True),False),
               pytest.param(('00:00:01:00', 'auto', 24, False, True),('1.0', 'auto', 25, False, True),True,marks=pytest.mark.xfail(raises=DFTTTimecodeOperatorError)),
               (('00:00:01:00', 'auto', 24, False, True),('00:00:00,500', 'auto', 24, False, True),False),
               (('00:00:01:00', 'auto', 24, False, True),22,False),
               (('1919', 'auto', 24, False, True),114514,True),
               (('2s', 'auto', 24, False, True),999,True),
...
@pytest.mark.parametrize(
    ...
    argvalues=[(('00:00:01:00', 'auto', 24, False, True),1.0),
