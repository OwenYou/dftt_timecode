...
@pytest.mark.parametrize(
    ...
    [
        ...
        ("00:01:00;02", "auto", 29.97, True, True),
        pytest.param("00:01:00:02", "auto", 29.97, False, True),
    ],
    ids=["smpte", "frame", "time", "smpte_df", "smpte_ndf"],
)
...
@pytest.mark.parametrize(
    ...
    argvalues=[
        pytest.param(
            ...
            marks=pytest.mark.xfail(raises=DFTTTimecodeOperatorError),
        ),
